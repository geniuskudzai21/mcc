            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 md:mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 md:mb-6">
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 md:mb-2">Service Request Queue</h1>
                            <p className="text-gray-600 text-sm">Manage and track municipal service requests</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                        <div className="bg-white rounded-xl border border-gray-200 p-4 md:p-6 shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300 transform hover:-translate-y-1">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-xs md:text-sm text-gray-600 mb-1">Total Requests</p>
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-4 md:p-6 shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300 transform hover:-translate-y-1">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xl md:text-2xl font-bold text-gray-900">{stats.resolved}</p>
                                </div>
                    ...
                    {/* Search Bar */}
                    <div className="bg-white rounded-xl border border-gray-200 p-3 md:p-4 shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    {filteredRequests.length === 0 && (
                        <div className="col-span-full bg-white rounded-xl border border-gray-200 p-8 md:p-12 text-center shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300 transform hover:-translate-y-1">
                            ...
                            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">No service requests found</h3>
                            ...
                            <div className="p-4 md:p-6">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 px-2 md:px-3 py-1.5 md:py-2 text-xs md:text-sm font-medium text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-sm shadow-blue-600/10 hover:shadow-md hover:shadow-blue-600/20"
                                    >
                                        Update
                                    </button>
                                    <button
                                        onClick={() => handleEdit(request)}
                                        className="p-1.5 md:p-2 text-gray-600 hover:bg-gray-50 rounded-lg transition-all duration-300 transform hover:scale-110"
                                        title="Edit Request"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="p-1.5 md:p-2 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-300 transform hover:scale-110"
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl shadow-blue-600/30 animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="p-4 md:p-6">
                            <select
                                ...
                                className="w-full px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4 md:mb-6"
                            >
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl border border-gray-200 w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl shadow-blue-600/30 animate-in fade-in zoom-in duration-300">
                        <div className="p-4 md:p-6 border-b border-gray-200">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="text-lg md:text-xl font-bold text-gray-900">Edit Request</h3>
                                    <p className="text-sm text-gray-600">Update request details</p>
                                </div>
                                <button 
                        ...
                        <div className="p-4 md:p-6 space-y-3 md:space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-3 md:px-4 py-2 md:py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                                />
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:p-6 border-t border-gray-200">
                            <div className="flex flex-col sm:flex-row gap-2 md:gap-3">
                                ...
                                <button
                                    onClick={() => {
                                        if (selectedRequest) {
                                            editRequestMutation.mutate({ id: selectedRequest.id, data: editForm });
                                        }
                                    }}
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl border border-gray-200 w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl shadow-blue-600/30 animate-in fade-in zoom-in duration-300">
                        <div className="p-4 md:p-6 text-center">
                            ...
                            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Delete Request</h3>
